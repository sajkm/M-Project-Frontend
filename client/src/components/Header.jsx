...
export default function Header() {
  ...
  return (
    <header className="shadow-md bg-blue-200">
      <div className="flex items-center justify-between max-w-6xl p-3 mx-auto">
        <Link to="/">
          <h1 className="flex flex-wrap text-sm font-bold sm:text-xl">
            <span className="text-slate-700"><i class="fa-solid fa-bounce fa-city"></i> Estatedo</span>
          </h1>
        </Link>
        <form
        ...
        <ul className="flex gap-4">
          <Link to="/">
            <li className="hidden sm:inline p-2 border shadow rounded text-slate-700 hover:underline">
              Home
            </li>
          </Link>
          <Link to="/about">
